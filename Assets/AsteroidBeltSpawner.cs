...
public class AsteroidBeltSpawner : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < cubeDensity; i++)
        {
            ...
            float size = Random.RandomRange(1, 20);
            ...
            //_asteroid.AddComponent<AsteroidBeltSpawner>().SetupBeltObject(Random.Range(minOrbitSpeed, maxOrbitSpeed), Random.Range(minRotationSpeed, maxRotationSpeed), gameObject, rotatingClockwise);
